...
export default function AddTeacherPage() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-start p-4 sm:p-6 md:p-10 bg-gray-100">
      <div className="w-full max-w-md sm:max-w-lg bg-white shadow-lg rounded-xl p-6 sm:p-8">
        <h1 className="text-2xl font-bold text-gray-800 text-center mb-6">
          Add New Teacher
        </h1>

        <form onSubmit={handleSubmit} className="space-y-5">
          {/* Grid adjusts for mobile automatically */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* Subject */}
            <div>
              <label className="block text-sm text-gray-600 mb-1">Specialised Subject</label>
              <input
                type="text"
